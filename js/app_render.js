...
function render(){
  ...
  <div class="modal-overlay" onclick="if(event.target===this)closeModal()">
    <div class="modal">
      ...
      <div class="form-group"><label class="form-label">운동 / 레슨 내용 <button type="button" class="ex-add-btn" onclick="openExercisePicker()">+ 운동 빠른추가</button></label><textarea class="form-textarea" placeholder="오늘 진행한 내용을 입력하세요" oninput="updateNS('content',this.value)">${S.newSession.content}</textarea></div>
